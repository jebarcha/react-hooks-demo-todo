...
describe('Pruebas en hook useFetch', () => {
    ...
    test('debe de manejar el error, data null, loading false, error true', async () => {

        const { result, waitForNextUpdate } = renderHook(() => useFetch('https://reqres.in/api1/users?page=2'));
        await waitForNextUpdate();
